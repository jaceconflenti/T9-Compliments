...
conn = sqlite3.connect('compliments.db')

c = conn.cursor()

c.execute('DROP TABLE IF EXISTS compliments')
c.execute('''CREATE TABLE compliments (compliment text)''')
c.execute('''INSERT INTO compliments VALUES ("Your smile is contagious."),
	...
	("If you were in a chemistry class with me, it would be x less boring."),
...
for row in c.execute('SELECT * FROM compliments'):
	print(row)
